     ...
     <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Impressum</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Angaben gemäß § 5 TMG</p>
                </div>
            </div>
        </header>
    <main>
    <!--automatic generated by https://www.impressum-generator.de-->
    <div class='impressum'>
    <p><strong>Anschrift:</strong><br>
    DHBW Mosbach Campus Bad Mergentheim <br> 
    Schloss 2<br> 
    97980 Bad Mergentheim <br> 
    </p><p><strong>Kontakt:</strong> <br>
    Telefon: 07931-123456789<br>
    E-Mail: <a href='mailto:aquaweb@gmail.de'>aquaweb@gmail.de</a><br></p><p>
